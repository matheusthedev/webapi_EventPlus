...
builder.Services.AddScoped<ITipoEventoRepository, TiposEventoRepository>();
builder.Services.AddScoped<ITiposUsuariosRepository, TiposUsuariosRepositoty>();
